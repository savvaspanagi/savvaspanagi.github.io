...
summary: "Often in situations of use machine learnings methods, we have to consider how to handle the cyclic features. For example in K-Means algorithm it use Euclidean distance in order to sort the available data\u2019s in clusters. In this situations the distance between the hour 0 (00:00) fr"
date: 2023-08-26
authors:
  - me
tags:
...
![ \begin{align*} x &= \sin\left(\frac{a \cdot 2\pi}{\max(a) + 1}\right) \\ y &= \cos\left(\frac{a \cdot 2\pi}{\max(a) + 1}\right) \end{align*} ](https://savvaspanagi.com/wp-content/ql-cache/quicklatex.com-a9b92d84f66b49331edfcbe82285299b_l3.png)
...
![](https://savvaspanagi.com/wp-content/uploads/2023/08/image.png)

Now let’s try to represent the above data’s in x and y axes of scatter plot (x_axes=Sin , y_axes=Cos) : 

![](https://savvaspanagi.com/wp-content/uploads/2023/08/image-1.png)
...
![](https://savvaspanagi.com/wp-content/uploads/2023/08/image-2-1024x576.png)

In our simple problem there are 2D points and after applying the formulas the distance is the following:

![](https://savvaspanagi.com/wp-content/uploads/2023/08/image-3.png)
