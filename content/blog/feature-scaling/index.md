...
summary: "following the previous article about handle cyclical features, feature scaling is also important when we are going to use a machine learning algorithms. Is a method to scale the features in a comparative form. But, how can we scaling it ? w"
date: 2023-08-29
authors:
  - me
tags:
...
**Standardization (Z-Score Transform):**
